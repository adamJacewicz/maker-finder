...
const Input = forwardRef<HTMLInputElement, InputProps>(({ label, icon: Icon, ...props }, ref) => {
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="flex items-center bg-theme-secondary border-gray-500 border rounded-md w-full relative">
        <input
          ...
          ref={ref}
          className={clsx(
            'appearance-none block pl-3 py-2 bg-transparent border-none focus:outline-none focus:ring-1 focus:ring-theme-accent focus:border-theme-accent sm:text-sm form-control',
